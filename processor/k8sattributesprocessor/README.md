...
- `watch_sync_period` (`default: 30m`): The resync period for K8s informers. You may set this to `0s` to disable resyncing completely (recommended for large clusters).
...
| `watch_sync_period` | duration | `30m` | Resync period for K8s informers (`0s` disables resync completely) |
