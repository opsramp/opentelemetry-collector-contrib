...
| Issues        | [![Open issues](https://img.shields.io/github/issues-search/open-telemetry/opentelemetry-collector-contrib?query=is%3Aissue%20is%3Aopen%20label%3Aexporter%2Fopsrampdebug%20&label=open&color=orange&logo=opentelemetry)](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues?q=is%3Aopen+is%3Aissue+label%3Aexporter%2Fopsrampdebug) [![Closed issues](https://img.shields.io/github/issues-search/open-telemetry/opentelemetry-collector-contrib?query=is%3Aissue%20is%3Aclosed%20label%3Aexporter%2Fopsrampdebug%20&label=closed&color=blue&logo=opentelemetry)](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues?q=is%3Aclosed+is%3Aissue+label%3Aexporter%2Fopsrampdebug) |
...
This is a custom version of the debug exporter from opentelemetry-collector, adapted for OpsRamp use cases.
...
```console
2025-04-17T10:40:44.559+0200    info    Traces  {"otelcol.component.id": "opsrampdebug/basic", "otelcol.component.kind": "Exporter", "otelcol.signal": "traces", "resource spans": 1, "spans": 2}
```
...
```console
2025-05-09T19:57:16.332+0200    info    Traces  {"resource": {}, "otelcol.component.id": "opsrampdebug/normal", "otelcol.component.kind": "exporter", "otelcol.signal": "traces", "resource spans": 1, "spans": 2}
...
lets-go ab1030bd4ee554af936542b01d7b4807 0d238e8a2f97733f net.sock.peer.addr=1.2.3.4 peer.service=telemetrygen-server
        {"resource": {}, "otelcol.component.id": "opsrampdebug/normal", "otelcol.component.kind": "exporter", "otelcol.signal": "traces"}
```
...
```console
2025-04-17T10:40:44.560+0200    info    Traces  {"otelcol.component.id": "opsrampdebug/detailed", "otelcol.component.kind": "Exporter", "otelcol.signal": "traces", "resource spans": 1, "spans": 2}
...
Attributes:
     ...
     -> peer.service: Str(telemetrygen-server)
        {"otelcol.component.id": "opsrampdebug/detailed", "otelcol.component.kind": "Exporter", "otelcol.signal": "traces"}
```
