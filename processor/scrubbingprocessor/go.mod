module github.com/open-telemetry/opentelemetry-collector-contrib/processor/scrubbingprocessor
...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/httpprovider v1.58.0 // indirect
